...
public class AzureClientSecretService {
  ...
  public static HashMap<String, String> getADLSSecretsUsingJceksAndKV(String keyVaultUrl, HashMap<String, String> credMap, String JcekPath) {
    /* First get the credentials to access KeyVault from Jceks file */
    HashMap<String, String> keymap = new HashMap<String, String>();
    try {
      keymap = getSecretsFromJcek("fs.adl.oauth2.client.id,fs.adl.oauth2.credential", JcekPath);
  ...
  public static HashMap<String, String> getSecretsFromJcek(String csvKeys, String JcekPath) throws IOException {
    ...
    //"localjceks://file/Users/rishabh.budhouliya/Desktop/adls.jceks"
    c.set(CredentialProviderFactory.CREDENTIAL_PROVIDER_PATH, JcekPath);
  ...
  protected static HashMap<String, String> getKvKeyNamesMap(String kvKeyNames) {
